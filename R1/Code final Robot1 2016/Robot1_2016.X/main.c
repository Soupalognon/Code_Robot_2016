...
/******************************************************************************/
    ...
    uint8_t volatile MOUVEMENT_AX12 = 0;
    volatile uint8_t ACTIVE_ROTATION_AX12 = 0;
...
//    while(1)
//    {
//        angle_AX12(PINCE_D, 850, 500, SANS_ATTENTE); //Position où il attrappe
//        angle_AX12(PINCE_G, 180, 500, SANS_ATTENTE); //Positions où il attrappe
 ...
 * angle_AX12(ASCENSEUR, 725, 512, SANS_ATTENTE);   //Position nominal
 * angle_AX12(ASCENSEUR, 745, 512, SANS_ATTENTE);   //Position pour soulever
 * 
 ...
 * angle_AX12(DEPLOIMENT_BRAS_FILET, 720, 200, SANS_ATTENTE);   //Position intermédiaire (pour passé la barre du filet)
 * 
 ...
 * angle_AX12(PINCE_D, 286, 100, SANS_ATTENTE); //Position rangé
 * angle_AX12(PINCE_D, 850, 500, SANS_ATTENTE); //Position où il attrappe
 * angle_AX12(PINCE_D, 720, 100, SANS_ATTENTE); //Position intermédiaire (où il est sur le point d'attraper)
 * angle_AX12(PINCE_D, 640, 300, SANS_ATTENTE); //Position intermédiaire (où il ferme les cabines)
 * 
 * angle_AX12(PINCE_G, 745, 100, SANS_ATTENTE); //Position rangé
 * angle_AX12(PINCE_G, 180, 500, SANS_ATTENTE); //Positions où il attrappe
 * angle_AX12(PINCE_G, 350, 100, SANS_ATTENTE); //Position intermédiaire (où il est sur le point d'attraper)
