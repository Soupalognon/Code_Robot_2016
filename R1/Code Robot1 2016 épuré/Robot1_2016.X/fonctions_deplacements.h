...
//Fonction qui gère les cas d'évitement
 ...
 * @param pourcentage_vitesse : Vitesse désirée de 0 à 100%
 * 
 * La particularité de cette fonction est qu'elle a une detection de bloquage 100 fois plus
 * élevé que les autres fonctions
 */
