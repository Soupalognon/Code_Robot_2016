...
void init_system(void)
{
    ...
    COULEUR = VIOLET; //Donne une couleur de base qui est changé après (évite les bugs)
...
void ConfigPorts(void)
{
    ...
    _TRISA0 = 1;
    _CN2IE = 0;
    _CN2PUE = 0; // IN  : (ANALOG) Courant_G (AN0)
    _TRISA1 = 1;
    _CN3IE = 0;
    _CN3PUE = 0; // IN  : (ANALOG) Courant_D (AN1)
    _TRISA2 = 1; // IN  : (DIGIT) capteur 1
    _TRISA3 = 1;
    _CN29IE = 0;
    _CN29PUE = 0; // IN  : (DIGIT) capteur 2
    _TRISA4 = 1;
    _CN0IE = 0;
    _CN0PUE = 0; // IN  : (DIGIT) capteur 3
    ...
    _TRISB0 = 0;
    _CN4IE = 0;
    _CN4PUE = 0; // RES : PGED1 pour programmation
    _TRISB1 = 0;
    _CN5IE = 0;
    _CN5PUE = 0; // RES : PGEC1 pour programmation
    _TRISB2 = 0;
    _CN6IE = 0;
    _CN6PUE = 0; // OUT : (DIGIT)  Photomos 1
    _TRISB3 = 0;
    _CN7IE = 0;
    _CN7PUE = 0; // OUT : (DIGIT)  Photomos 2
    _TRISB4 = 1;
    _CN1IE = 0;
    _CN1PUE = 0; // IN  : Jack
    _TRISB5 = 1;
    _CN27IE = 0;
    _CN27PUE = 0; // IN  : RX AX12
    _TRISB6 = 0;
    _CN24IE = 0;
    _CN24PUE = 0; // OUT : TX AX12
    _TRISB7 = 0;
    _CN23IE = 0;
    _CN23PUE = 0; // OUT : DIR UART AX12
    _TRISB8 = 0;
    _CN22IE = 0;
    _CN22PUE = 0; // RES : SCL1
    _TRISB9 = 0;
    ...
    _TRISB10 = 0;
    _CN16IE = 0;
    _CN16PUE = 0; // OUT : PWM1H3 : moteur gauche
    _TRISB11 = 0;
    _CN15IE = 0;
    _CN15PUE = 0; // OUT : SENS   : moteur gauche
    _TRISB12 = 0;
    _CN14IE = 0;
    _CN14PUE = 0; // OUT : PWM1H2 : moteur droit
    _TRISB13 = 0;
    _CN13IE = 0;
    _CN13PUE = 0; // OUT : SENS   : moteur droit
    _TRISB14 = 1;
    _CN12IE = 0;
    _CN12PUE = 0; // IN  : RX XBEE
    _TRISB15 = 0;
    _CN11IE = 0;
    _CN11PUE = 0; // OUT : TX XBEE

    // Config PORTC
    _TRISC0 = 1;
    _CN8IE = 0;
    _CN8PUE = 0; // IN  : (ANALOG/DIGIT)  capteur 6 (AN6)
    _TRISC1 = 1;
    _CN9IE = 0;
    _CN9PUE = 0; // IN  : (ANALOG/DIGIT)  capteur 7 (AN7)
    _TRISC2 = 1;
    _CN10IE = 0;
    _CN10PUE = 0; // IN  : (ANALOG/DIGIT)  capteur 8 (AN8)
    _TRISC3 = 1;
    _CN28IE = 0;
    _CN28PUE = 0; // IN  : (DIGIT) : capteur 9
    _TRISC4 = 1;
    _CN25IE = 0;
    _CN25PUE = 0; // IN  : (DIGIT) : capteur 10
    _TRISC5 = 0;
    _CN26IE = 0;
    _CN26PUE = 0; // OUT : (DIGIT) : LED Debug
    _TRISC6 = 1;
    _CN18IE = 0;
    _CN18PUE = 0; // IN  : QEA2
    _TRISC7 = 1;
    ...
    _TRISA0 = 0;
    _CN2IE = 0;
    _CN2PUE = 0; // OUT : (DIGIT) : Inhibit AX12
    _TRISA1 = 0;
    _CN3IE = 0;
    _CN3PUE = 0; // OUT : (DIGIT) : DIR_UART_AX12
    _TRISA2 = 1; // IN  : (DIGIT) : Capteur 1
    _TRISA3 = 1;
    _CN29IE = 0;
    _CN29PUE = 0; // IN  : (DIGIT) : capteur 2
    ...
    _TRISB2 = 0;
    _CN6IE = 0;
    _CN6PUE = 0; // INT : (UART)  : TX AX12
    _TRISB3 = 1;
    _CN7IE = 0;
    _CN7PUE = 0; // OUT : (UART)  : RX AX12
    _TRISB4 = 1;
    _CN1IE = 0;
    _CN1PUE = 0; // IN  : (DIGIT) : Capteur 5
    _TRISB5 = 1;
    _CN27IE = 0;
    _CN27PUE = 0; // IN  : (UART)  : RX XBEE
    _TRISB6 = 0;
    _CN24IE = 0;
    _CN24PUE = 0; // OUT : (UART)  : TX XBEE
    _TRISB7 = 0;
    _CN23IE = 0;
    _CN23PUE = 0; // OUT : (DIGIT) : RESET XBEE
    _TRISB8 = 0;
    _CN22IE = 0;
    _CN22PUE = 0; // RES : (I²C)   : SCL1
    _TRISB9 = 0;
    _CN21IE = 0;
    _CN21PUE = 0; // RES : (I²C)   : SDA1
    _TRISB10 = 0;
    _CN16IE = 0;
    _CN16PUE = 0; // OUT : (DIGIT) : sens moteur gauche
    _TRISB11 = 0;
    _CN15IE = 0;
    _CN15PUE = 0; // OUT : (PWM)   : PWM1L3 (moteur gauche)
    _TRISB12 = 0;
    _CN14IE = 0;
    _CN14PUE = 0; // OUT : (DIGIT) : sens moteur droit
    _TRISB13 = 0;
    _CN13IE = 0;
    _CN13PUE = 0; // OUT : (PWM)   : PWM1L2 (moteur droit)
    _TRISB14 = 0;
    _CN12IE = 0;
    _CN12PUE = 0; // OUT : (DIGIT) : sens moteur X
    _TRISB15 = 0;
    _CN11IE = 0;
    _CN11PUE = 0; // OUT : (PWM)   : PWM1H1 (moteur X)
    ...
    _TRISC3 = 1;
    _CN28IE = 0;
    _CN28PUE = 0; // IN  : (DIGIT) : Jack
    _TRISC4 = 1;
    _CN25IE = 0;
    _CN25PUE = 0; // IN  : (DIGIT) : Strat
    _TRISC5 = 0;
    _CN26IE = 0;
    _CN26PUE = 0; // OUT : (DIGIT) : LED Debug
    _TRISC6 = 1;
